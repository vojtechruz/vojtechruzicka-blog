    ...
    render() {
        ...
        return (
            <span className="search-box-container">
                <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={classNames('search-icon', {'active': this.state.active})}
                ...
                <input className={this.inputClass} placeholder="Search" ref={(input) => {this.searchInput = input;}} onFocus={this.activate.bind(this)} onBlur={this.deactivate.bind(this)}></input>
            </span>
        );
    }

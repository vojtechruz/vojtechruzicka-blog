...
Note that it applies to function calls, where the function is not called as a property of an object. e.g. `object.function()`. In such cases, it is actually method invocation, which follows different rules (see below).

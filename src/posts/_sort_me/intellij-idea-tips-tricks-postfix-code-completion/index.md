...
You can see it is able to properly determine type of the exception from the method and in case there are multiple exceptions it will add catch block for each of them.

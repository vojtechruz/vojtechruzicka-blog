...
{% codepen "mdJamVb", "Position relative" %}
...
{% codepen "vYObeJw", "Position absolute" %}
...
{% codepen "YzXBrLo", "Position absolute - Parent is not relative, items positioned based on whole page, not parent" %}
...
{% codepen "JjdxrBw", "Position absolute - elements are removed from document flow and don't reserve space" %}
...
{% codepen "xxGMweV", "Position fixed" %}
...
{% codepen "vYObLja", "Position sticky" %}
...
{% codepen "abOPmwy", "How z index affects order of elements" %}

...
<Video src={props.data.mdx.frontmatter.path+"idea-replace-with-switch-expression"} />
...
<Video src={props.data.mdx.frontmatter.path+"idea-add-default-branch"} />
...
<Video src={props.data.mdx.frontmatter.path+"idea-merge-branches"} />

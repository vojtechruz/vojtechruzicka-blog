...
<Video src={props.data.mdx.frontmatter.path+"column-selection"} />
...
<Video src={props.data.mdx.frontmatter.path+"clone-caret"} />
...
<Video src={props.data.mdx.frontmatter.path+"multiple-cursors-mouse"} />
...
<Video src={props.data.mdx.frontmatter.path+"multi-selection"} />
...
<Video src={props.data.mdx.frontmatter.path+"select-all-occurences"} />
...
<Video src={props.data.mdx.frontmatter.path+"add-occurrence"} />
...
<Video src={props.data.mdx.frontmatter.path+"remove-occurrence"} />

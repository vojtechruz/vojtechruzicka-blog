...
excerpt: How to make the most of the IntelliJ IDEA's view modes to make the best presentations possible including visualization of the keyboard input?
draftStatus: draft
---
...
<Video src={props.data.mdx.frontmatter.path+"quick-switch-theme"} />

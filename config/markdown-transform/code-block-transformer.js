export const codeBlockTransformer = {
  ...
  root(root) {
    ...
    const meta = typeof this.options.meta === 'string'
      ? this.options.meta
      ...
      children: [
        {
          ...
          children: [{
            ...
            children: [{
              type: "element",
              tagName: "path",
              properties: { d: "M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 18H8V7h11v16z" }
            }]
          }]
        },
        {
